        ...
        case IDC_ABOUT_MORE:
            {
                ...
                std::wstring path(n, 0);
                SendMessage(plugin.nppData._nppHandle, NPPM_GETPLUGINHOMEPATH, n + 1, reinterpret_cast<LPARAM>(path.data()));
                std::wstring changes = path + L"\\Search++\\CHANGELOG.md";
                ...
                std::wstring license = path + L"\\Search++\\LICENSE.txt";
                ...
                std::wstring readme = path + L"\\Search++\\README.md";
